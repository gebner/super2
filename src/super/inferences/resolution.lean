...
meta def inference.resolution : inference_rule | given := do
active ← get_active,
retrieve_packed $ do
  (c1, i1, literal.pos a1) ← get_selected_lits (given :: active.values) | [],
  (c2, i2, literal.neg a2) ← get_selected_lits (given :: active.values) | [],
  pure $ do
